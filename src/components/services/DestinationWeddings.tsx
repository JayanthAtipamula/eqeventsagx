        ...
        <Parallax speed={10}>
          <div className="max-w-3xl mx-auto mb-6">
            ...
            <p className="text-gray-300 mb-2">
              From Mediterranean beaches to Alpine resorts, we bring our premium DJ and entertainment services to your chosen destination. Our experienced team handles all the logistics, ensuring your wedding entertainment is flawless, no matter where in the world you celebrate.
            </p>
